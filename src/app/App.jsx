...
export default function App() {
  ...
  const todayTasks = useMemo(() => tasks.filter((task) => task.calendarDate === todayKey || /^Hoy\b/i.test(task.due || '')), [tasks, todayKey])
  const todayEvents = todayTasks.length
